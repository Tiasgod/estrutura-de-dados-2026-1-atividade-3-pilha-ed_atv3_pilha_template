...
public class App {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                case 1: executarExercicio01(); break;
                case 2: executarExercicio02(); break;
                case 3: executarExercicio03(scanner); break;
                case 4: executarExercicio04(scanner); break;
                case 5: executarExercicio05(scanner); break;
                case 6: executarExercicio06(scanner); break;
        ...
        do {
            ...
            switch (opcao) {
                case 1:
                    ...
                    break;
                case 2:
                    if (!pilha.isEmpty()) System.out.println("Removido: " + pilha.pop());
                    else System.out.println("Pilha vazia.");
                    break;
                case 3:
                    if (!pilha.isEmpty()) System.out.println("Topo: " + pilha.peek());
                    else System.out.println("Pilha vazia.");
                    break;
                case 4:
                    System.out.println("Pilha: " + pilha);
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out.println(removida != null ? "Voltou da pagina: " + removida : "Historico vazio.");
                    break;
                case 3:
                    String atual = paginaAtual(historico);
                    System.out.println(atual != null ? "Pagina atual: " + atual : "Nenhuma pagina aberta.");
                    break;
                case 4:
